...
[task_local]
#直播间抽奖（全局）
5 12 * * 6 https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/jd_live_lottery_social.js, tag=直播间抽奖（全局）, enabled=true

================Loon==============
[Script]
cron "5 12 * * 6" script-path=https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/jd_live_lottery_social.js,tag=直播间抽奖（全局）

===============Surge=================
直播间抽奖（全局） = type=cron,cronexp="5 12 * * 6",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/jd_live_lottery_social.js

============小火箭=========
直播间抽奖（全局）= type=cron,script-path=https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/jd_live_lottery_social.js, cronexpr="5 12 * * 6",timeout=200, enable=true
 */
